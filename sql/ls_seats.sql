...
CREATE TABLE `ls_seats`  (
  ...
  `type` varchar(24) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '对应seat_type表中的id',
...
) ENGINE = InnoDB AUTO_INCREMENT = 4647 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '座位表' ROW_FORMAT = Dynamic;
